...
BOOL MoveCharTo(DWORD dwPlayerID, WORD wPlayerX, WORD wPlayerY, WORD x, WORD y); // move char
void RandMove(WORD wPlayerX, WORD wPlayerY, WORD wRange);
BOOL CheckPosition(WORD wPlayerX, WORD wPlayerY, WORD x, WORD y, WORD offset);
